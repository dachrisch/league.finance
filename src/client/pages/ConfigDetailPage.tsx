  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem', fontFamily: 'sans-serif' }}>
      <button
        ...
        style={{ background: 'none', border: 'none', cursor: 'pointer', marginBottom: '1.5rem', color: '#0d6efd', padding: 0, fontSize: 16 }}
      >
        ← Back to Dashboard
      </button>
      ...
      {stats && (
        <section style={{ display: 'flex', gap: '1.5rem', marginBottom: '2.5rem' }}>
          <div style={{ flex: 1, padding: '1.25rem', background: '#f8f9fa', borderRadius: 8, borderTop: '4px solid #0d6efd' }}>
          ...
          <div style={{ flex: 1, padding: '1.25rem', background: '#f8f9fa', borderRadius: 8, borderTop: '4px solid #dc3545' }}>
          ...
          <div style={{ flex: 1, padding: '1.25rem', background: '#f8f9fa', borderRadius: 8, borderTop: '4px solid #198754' }}>
            ...
            <tbody>
              {stats.details.map((d: any) => (
                <tr key={d.teamId} style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: '12px 15px' }}>{d.teamName}</td>
                  <td style={{ padding: '12px 15px', textAlign: 'right' }}>{d.gross.toFixed(2)} €</td>
                  <td style={{ padding: '12px 15px', textAlign: 'right', fontWeight: 'bold', color: '#198754' }}>{d.net.toFixed(2)} €</td>
                </tr>
              ))}
            </tbody>
          </table>
